...
public class jsactions {
	...
	public static void main(String[] args) throws InterruptedException {
       ...
       // sultan = new caniche();     
	    ...
	    WebElement miboton = driver.findElement(By.id("continue")); // Variable con Elemento WEB
	    js.executeScript("arguments[0].scrollIntoView();", miboton ); // Scroll hasta el elemento seleccionado
